...
from PyQt5.QtWidgets import (
    QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QStyle, QStatusBar,
...
class UIBuilder:
    ...
    def _configure_plots(self):
        ...
        self.win.template_bargraph = pg.BarGraphItem(x=np.arange(12)-0.2, height=np.zeros(12), width=0.4, brush=pg.mkBrush(255, 255, 255, 100), name='Ideal Template')
        self.win.pcp_bargraph = pg.BarGraphItem(x=np.arange(12)+0.2, height=np.zeros(12), width=0.4, brush=pg.mkBrush(0, 150, 255, 200), name='Live Audio')
        ...
        self.win.chord_table.setHorizontalHeaderLabels(["Start (s)", "End (s)", "Chord", "Confidence"])
        ...
        self.win.chord_table.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
    ...
    def _setup_playheads(self):
        ...
        self.win.playhead_timeline = pg.InfiniteLine(angle=90, movable=False, pen=playhead_pen)
        self.win.playhead_chroma = pg.InfiniteLine(angle=90, movable=False, pen=playhead_pen)
        self.win.playhead_waveform = pg.InfiniteLine(angle=90, movable=False, pen=playhead_pen)
